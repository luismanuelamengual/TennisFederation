...
@section("contents")
    ...
    <div id="bs10" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img class="img-responsive" style="width:100%; height: 500px" src="{{ $this->getBaseUrl() }}images/background1.jpg" />
            ...
            <div class="item">
                <img class="img-responsive" style="width:100%; height: 500px" src="{{ $this->getBaseUrl() }}images/background3.jpg" />
                <div class="carousel-caption">
                    <h3>Federación Mendocina de Tenis</h3>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-sm-4">
                <img class="img-thumbnail" src="{{ $this->getBaseUrl() }}images/featurette3.jpg" data-src="holder.js/260x175" alt="" style="width: 260px; height: 175px;">
                <h2>Menores</h2>
            </div>
            <div class="col-sm-4">
                <img class="img-thumbnail" src="{{ $this->getBaseUrl() }}images/featurette7.jpg" data-src="holder.js/260x175" alt="" style="width: 260px; height: 175px;">
                <h2>Categorías - Seniors</h2>
            </div>
            <div class="col-sm-4">
                <img class="img-thumbnail" src="{{ $this->getBaseUrl() }}images/featurette5.jpg" data-src="holder.js/260x175" alt="" style="width: 260px; height: 175px;">
                <h2>Profesionales</h2>
            </div>
        </div>
        <hr class="featurette-divider">
