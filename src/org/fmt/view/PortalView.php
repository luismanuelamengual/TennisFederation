<?php $this->loadScript("org\\fmt\\view\\SiteView"); ?>

<?php $this->beginContent("body"); ?>
...
<?php $this->beginContent("contents"); ?>
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="<?php echo $this->getBaseUrl(); ?>res/images/background1.jpg" alt="">
        ...
        <div class="item">
            <img src="<?php echo $this->getBaseUrl(); ?>res/images/background4.jpg" alt="">
            <div class="carousel-caption">
                <h1 style="color:#ffffff">Federación Mendocina de Tenis</h1>
...
<div class="container">
    <div class="row text-center">
        <div class="col-sm-4">
            <img class="img-thumbnail" src="<?php echo $this->getBaseUrl(); ?>res/images/featurette3.jpg" data-src="holder.js/260x175" alt="" style="width: 260px; height: 175px;">
            <h2>Menores</h2>
        </div>
        <div class="col-sm-4">
            <img class="img-thumbnail" src="<?php echo $this->getBaseUrl(); ?>res/images/featurette7.jpg" data-src="holder.js/260x175" alt="" style="width: 260px; height: 175px;">
            <h2>Categorías - Seniors</h2>
        </div>
        <div class="col-sm-4">
            <img class="img-thumbnail" src="<?php echo $this->getBaseUrl(); ?>res/images/featurette5.jpg" data-src="holder.js/260x175" alt="" style="width: 260px; height: 175px;">
            <h2>Profesionales</h2>
        </div>
    </div>
